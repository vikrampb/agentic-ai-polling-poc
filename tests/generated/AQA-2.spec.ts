...
test.describe('AQA-2 – Happy Path', () => {
  test('PBE team user can log in successfully and receives a welcome message', async ({ request }) => {
  ...
  test('DPS team user can log in successfully and receives a welcome message', async ({ request }) => {
    const users = await getUsers(request);
...
test.describe('AQA-2 – Boundary Conditions', () => {
  ...
  test('User with no team assigned who is a US_PERSON can still log in successfully', async ({ request }) => {
    const users = await getUsers(request);
  ...
  test('User with no team assigned who is a NON_US_PERSON is blocked from logging in', async ({ request }) => {
    const users = await getUsers(request);
...
test.describe('AQA-2 – Negative Tests', () => {
  ...
  test('Login attempt with empty username and password returns missing credentials error', async ({ request }) => {
